...
var (
	...
	ErrInvalidSignUpInput = errors.New("domain: sign up requires at least phone number or email")
	ErrInvalidSignInInput = errors.New("domain: sign in requires at least phone number or email")
